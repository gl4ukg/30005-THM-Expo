...
export const mockedData: HoseData[] = [
  ...
  },
  {
    ...
    department: 'ALNABRU',
    itemDescription: '',
    RFID: 'E0040150A05E02CD',
    parentSystem: '1203108',
    s1Code: 1203108,
    s2Code: null,
    equipmentSubunit: 'Pump-Manifold Block P1 standard',
    hoseOtherInfo: 'Some other details',
    customerID: 'EQN-100',
    customerEq: 'customer_eq_01',
    system: 'system_01',
  ...
  },
  {
    ...
    genderEnd2: 'Female',
    angleEnd2: '90',
    materialQualityEnd2: 'Carbon Steel',
    generalCommentPTC: 'General comment',
    commentEnd1PTC: 'End 1 comment',
    commentEnd2PTC: 'End 2 comment',
    originalHoseComment: 'Original comment',
  ...
  },
  {
    ...
    insert1: 'string',
    insert2: 'string',
    couplingOrientation: 0,
    pinpricked: true,
    hoseMediumTemperature: 0,
    hoseFunction: 'string',
    hoseWarranty: 'string',
